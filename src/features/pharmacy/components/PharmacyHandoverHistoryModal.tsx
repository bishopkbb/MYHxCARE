...
import { HANDOVER_HISTORY } from '@/features/pharmacy/__mocks__/pharmacyShiftHandoverFixtures';
...
export function PharmacyHandoverHistoryModal({ onClose }: { onClose: () => void }) {
  return (
    <div
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-1.5" style={{ fontSize: 14, color: '#4A7080' }}>
                    {entry.outgoingPharmacist} → {entry.incomingPharmacist} · {entry.campus}
                  </p>
