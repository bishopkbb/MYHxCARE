...
export function CreateEditRecordsShiftModal({
  editingShift,
  onClose,
  onSave,
}: {
  editingShift?: RecordsShift | undefined;
  onClose: () => void;
  onSave: (shift: RecordsShift) => void;
}) {
