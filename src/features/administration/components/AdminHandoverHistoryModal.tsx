...
import { HANDOVER_HISTORY } from '@/features/administration/__mocks__/administrationShiftHandoverFixtures';
...
export function AdminHandoverHistoryModal({ onClose }: { onClose: () => void }) {
  return (
    <div
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-1.5" style={{ fontSize: 14, color: '#4A7080' }}>
                    {entry.outgoingOfficer} → {entry.incomingOfficer} · {entry.department}
                  </p>
