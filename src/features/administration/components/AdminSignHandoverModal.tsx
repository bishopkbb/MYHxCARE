...
import type { HandoverStaff } from '@/features/administration/__mocks__/administrationShiftHandoverFixtures';

const FOCUS_RING =
  'focus-visible:ring-2 focus-visible:ring-[#00B4D8]/50 focus-visible:outline-none';

export function AdminSignHandoverModal({
  officer,
  onConfirm,
  onClose,
}: {
        ...
        <div className="flex-1 px-6 py-5">
          ...
          <label className="mt-4 flex cursor-pointer items-start gap-2.5">
            ...
            <span style={{ fontSize: 14, color: '#2F3A40', lineHeight: '22px' }}>
              ...
              responsibility for the outstanding tasks listed above.
            </span>
          </label>
        </div>
