...
import type { AccessLogEntry } from '@/features/administration/__mocks__/accessLogFixtures';
      ...
      >
        ...
        <div className="px-6 py-5">
          <div className="grid grid-cols-2 gap-4">
            ...
            <DetailRow label="Login Type" value={entry.loginType} />
            ...
            <DetailRow label="OS" value={entry.os} />
          </div>
        </div>
