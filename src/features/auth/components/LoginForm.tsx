    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="mt-8">
        ...
        <button
          type="submit"
          disabled={isSubmitting}
          className="mt-4 flex h-13 w-full items-center justify-center gap-2.5 rounded-[12px] text-sm leading-5.5 font-medium text-white transition-opacity duration-150 hover:opacity-90 focus-visible:ring-2 focus-visible:ring-[#00B4D8]/50 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
          style={{
