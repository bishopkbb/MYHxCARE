...
export function CreateEditNurseShiftModal({
  editingShift,
  onClose,
  onSave,
}: {
  editingShift?: NurseShift | undefined;
  onClose: () => void;
  onSave: (shift: NurseShift) => void;
}) {
  ...
  function handleSubmit() {
    setSubmitted(true);
    if (!isValid) {
      toast.error('Required', 'Please fill in staff name, role, and ward.');
      return;
    }
        ...
        <div className="min-h-0 flex-1 overflow-y-auto scroll-smooth px-6 py-5">
          <div className="flex flex-col gap-4">
            ...
            >
              <FormInput
                id="shift-staff-name"
                placeholder="e.g. Chinyere Anyanwu"
                value={staffName}
