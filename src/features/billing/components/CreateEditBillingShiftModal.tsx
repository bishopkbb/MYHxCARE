...
export function CreateEditBillingShiftModal({
  editingShift,
  onClose,
  onSave,
}: {
  editingShift?: BillingShift | undefined;
  onClose: () => void;
  onSave: (shift: BillingShift) => void;
}) {
      ...
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto scroll-smooth px-6 py-5">
          <div className="flex flex-col gap-4">
            <FormField
              label="Staff Name"
              htmlFor="billshift-staff-name"
              required
              error={submitted && !staffName.trim() ? 'Required' : undefined}
            >
              <FormInput
                id="billshift-staff-name"
                placeholder="e.g. Ifeanyi Okonkwo"
                value={staffName}
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <FormField label="Shift Type" htmlFor="billshift-type">
                <FormSelect
                  id="billshift-type"
                  value={shiftType}
              ...
              <FormField label="Status" htmlFor="billshift-status">
                <FormSelect
                  id="billshift-status"
                  value={status}
