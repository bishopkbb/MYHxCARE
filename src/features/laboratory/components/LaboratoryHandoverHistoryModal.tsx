...
import { HANDOVER_HISTORY } from '@/features/laboratory/__mocks__/laboratoryShiftHandoverFixtures';

const FOCUS_RING =
  'focus-visible:ring-2 focus-visible:ring-[#00B4D8]/50 focus-visible:outline-none';

const SHIFT_CFG: Record<string, { color: string; bg: string; border: string }> = {
  Morning: { color: '#F97316', bg: 'rgba(249,115,22,0.1)', border: 'rgba(249,115,22,0.3)' },
  Afternoon: { color: '#00B4D8', bg: 'rgba(0,180,216,0.1)', border: 'rgba(0,180,216,0.3)' },
  Night: { color: '#8B5CF6', bg: 'rgba(139,92,246,0.1)', border: 'rgba(139,92,246,0.3)' },
};

export function LaboratoryHandoverHistoryModal({ onClose }: { onClose: () => void }) {
  return (
    <div
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-1.5" style={{ fontSize: 14, color: '#4A7080' }}>
                    {entry.outgoingScientist} → {entry.incomingScientist} · {entry.department}
                  </p>
