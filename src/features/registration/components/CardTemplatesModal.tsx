...
export function CardTemplatesModal({
  onClose,
  onUseTemplate,
}: {
  onClose: () => void;
  onUseTemplate: (cardType: CardType) => void;
}) {
  return (
    <div
        ...
        >
          <div>
            ...
            <p className="mt-0.5" style={{ fontSize: 14, color: '#4A7080' }}>
              Start a new card print pre-set to a template&apos;s card type.
            </p>
          </div>
          <button
            type="button"
          ...
          <div className="flex flex-col gap-2.5">
            {CARD_TEMPLATES.map((t) => (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => onUseTemplate(t.cardType)}
