...
import { LaboratoryWorkforceManagementWorkspace } from '@/features/laboratory/components/LaboratoryWorkforceManagementWorkspace';
      ...
      <main className="flex-1 overflow-y-auto scroll-smooth" style={{ background: '#F5FBFD' }}>
        <div className="mx-auto flex max-w-[1200px] flex-col items-center justify-center gap-3 px-4 py-24 text-center sm:px-6">
          ...
          <p style={{ fontSize: 14, color: '#8A98A3' }}>
            This screen is restricted to laboratory supervisors. Contact your supervisor if you need
            access.
          </p>
        </div>
      </main>
...
export default function LaboratoryWorkforceManagementPage() {
  return (
    <PermissionGate permission={PERMISSIONS.DUTY_ROSTER_WRITE} fallback={<AccessRestricted />}>
      <LaboratoryWorkforceManagementWorkspace />
    </PermissionGate>
  );
}
