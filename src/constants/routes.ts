export const ROUTES = {
  ...
  adminWorkflowSettings: '/admin/workflow-settings',
  adminDepartmentMonitoring: '/admin/department-monitoring',
  ...
  adminRevenueOverview: '/admin/revenue-overview',
  adminReports: '/admin/reports',
  adminFinancialReports: '/admin/reports/financial',
  adminDepartmentReports: '/admin/reports/department',
  adminAuditLog: '/admin/audit-log',
  adminAccessLog: '/admin/access-log',
