...
export function ExportMenu({
  ...
  const dropdown = open ? (
    <div
      className="absolute top-full right-0 z-50 mt-1 flex flex-col overflow-hidden rounded-[10px] bg-white"
      style={{
        minWidth: 168,
    ...
    >
      <button
        ...
        className="px-4 py-2.5 text-left font-sans transition-colors hover:bg-[rgba(0,180,216,0.05)]"
